...
HRESULT CMinotauros::AddComponent()
{
	...
	// Normal Texture
	component = m_normalTexCom = dynamic_cast<Engine::CTexture*>(Engine::CloneResource(Engine::RESOURCE_NORMAL, L"Texture_Minotauros_Normal"));
	NULL_CHECK_RETURN(component, E_FAIL);
...
HRESULT CMinotauros::SetUpConstantTable(LPD3DXEFFECT & effect)
{

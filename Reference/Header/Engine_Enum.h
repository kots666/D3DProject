...
namespace Engine
{
	...
	enum BUFFERID		{ BUFFER_TRICOL, BUFFER_RCCOL, BUFFER_RCTEX, BUFFER_CROSSTEX, BUFFER_TERRAINTEX, BUFFER_CUBETEX, BUFFER_TRAIL, BUFFER_PTTEX, BUFFER_INRCTEX };
	enum TEXTURETYPE	{ TEX_NORMAL, TEX_CUBE, TEX_END };
	
	enum RENDERID		{ RENDER_PRIORITY, RENDER_SKYBOX, RENDER_SHADOWDEPTH, RENDER_NONALPHA, RENDER_DISTORT, RENDER_ALPHA, RENDER_UI, RENDER_END };
